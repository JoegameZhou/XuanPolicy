...
class MAAC_Agents(MARLAgents):
    def __init__(self,
        ...
        memory = MARL_OffPolicyBuffer(state_shape,
                                      ...
                                      config.buffer_size,
                                      config.batch_size)
        learner = MAAC_Learner(config, policy, optimizer, scheduler, writer,
        ...
        super(MAAC_Agents, self).__init__(config, envs, policy, memory, learner, writer, device,
