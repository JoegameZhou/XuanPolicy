...
class MASAC_Learner(LearnerMAS):
    def __init__(self,
        ...
        super(MASAC_Learner, self).__init__(config, policy, optimizer, scheduler, summary_writer, device, modeldir)
        self.optimizer = {
            'actor': optimizer[0],
            'critic': optimizer[1]
        }
    ...
    def update(self, sample):
        ...
        actions_next = actions_next_dist.stochastic_sample()
        ...
        actions_eval = actions_dist.stochastic_sample()
