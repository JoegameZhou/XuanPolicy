...
from environment.pettingzoo.utils import wrappers
from environment.pettingzoo.utils.agent_selector import agent_selector
...
class SimpleEnv(AECEnv):
    def __init__(self, scenario, world, max_cycles, continuous_actions=True, local_ratio=None):
        super().__init__()
