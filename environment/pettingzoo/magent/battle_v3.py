...
from environment.pettingzoo import AECEnv
from environment.pettingzoo.magent.render import Renderer
from environment.pettingzoo.utils import agent_selector
from environment.pettingzoo.utils.conversions import from_parallel_wrapper, parallel_wrapper_fn

from .magent_env import magent_parallel_env, make_env

default_map_size = 40  # 45
max_cycles_default = 250  # 1000
KILL_REWARD = 5
