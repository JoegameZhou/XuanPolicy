...
from xuance_ms.policies import Policy_Inputs, Policy_Inputs_All
from xuance_ms.representations import Representation_Inputs, Representation_Inputs_All
...
def get_policy_in(args, representation):
    ...
    if policy_name in ["Basic_Q_network", "Duel_Q_network", "Noisy_Q_network", "C51_Q_network", "QR_Q_network"]:
        ...
        if policy_name in ["Categorical_AC", "Categorical_PPG", "Gaussian_AC", "DDPG_Policy", "TD3_Policy"]:
